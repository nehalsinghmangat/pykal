...
\begin{tikzpicture}[
  ...
  laserbeam/.style = {->, thick, red, dashed},
...
% === Add laser sensor and beam ===
\coordinate (laserbox) at (1.2,-\L-0.5);
\coordinate (beamend) at ($(pivot) + (270:\L+0.5)$);
\draw[laserbeam] (laserbox) -- (beamend);
\node[sensor] at (laserbox) {};
\node[below=4pt of laserbox] {Laser Sensor $(s)$};
